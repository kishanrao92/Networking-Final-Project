...
public class Client {
	...
	static void update_summary_file() throws FileNotFoundException, UnsupportedEncodingException {
		...
		File summary = new File("/Users/Kishan_Rao/Documents/workspace/PeertoPeer/src/client" + client_num,
				"summary.txt");
	...
	static void get_file(ObjectInputStream file_in) throws FileNotFoundException, IOException, ClassNotFoundException {
		...
		File newFile = new File("/Users/Kishan_Rao/Documents/workspace/PeertoPeer/src/client" + client_num, chunk_name);
	...
	void DownloadFromFileOwner() throws ClassNotFoundException, FileNotFoundException {
		...
		File configuration = new File("/Users/Kishan_Rao/Documents/workspace/PeertoPeer/src/config.txt");
		try {
		...
		public void run() {
			...
			while (true) {
				...
				if (own_files.size() == num_of_chunks) {
					...
					try {
						FileSplit.mergeFiles(own_files, "/Users/Kishan_Rao/Documents/workspace/PeertoPeer/src/client"
